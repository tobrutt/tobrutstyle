...
.whole {
    ...
    background-image: url(https://res.cloudinary.com/dzujj1seq/image/upload/v1733671728/background-tobrut_dumkj1.jpg);
    background-position: center;
    background-attachment: fixed;
    background-repeat: no-repeat;
    background-size: cover; /* Gambar memenuhi layar tanpa distorsi */
}
...
.header {
    ...
    color: '.kucrut_getColor("header_values").';
    font-size: 12px;
...
.inputfile strong {
    background-image: url('.__showicon('kucrutmini').');
    background-repeat: no-repeat;
...
.inputfile:focus strong,
.inputfile.has-focus strong,
.inputfile:hover strong {
...
td {
    padding: '.($GLOBALS['DB_NAME']['show_icons'] == '1' ? '0' : '1').'px;
}
...
input[type=submit] {
    cursor: pointer;
    background-image: url('.__showicon('btn').');
    background-repeat: no-repeat;
    background-position: 50% 50%;
...
function __showicon($r){
	...
	$s['kucrutmini']='https://iili.io/2M3GdE7.png';
